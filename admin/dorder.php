...
<?php
    ...
    $csm    = new Customer();
    $order  = new Order();
    $orderlist = $order->getCustomerdeliveredItem($customerId);
?>
<?php
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
		
		$moveorder = $order->deleteOrder($customerId);
                ...
                <div class="row">
                	<div class="col-md-offset-4  col-md-4 ">
                		...
                		<form action="" method="post">
                			<input type="submit" name="submit" value="Delete" class="btn btn-info btn-fill " onclick="return confirm('are you sure ??')">
                		</form>
                	</div>
                </div>
                <?php } ?>
