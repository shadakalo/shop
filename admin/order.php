...
<?php
    ...
    $csm    = new Customer();
    $order  = new Order();
    $orderlist = $order->getCustomerOrderedItem($customerId);
?>
<?php
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
		
		$moveorder = $order->moveToProcessing($customerId);
		echo "<script>alert('Order Moved to Processing list');</script>";
                ...
                <div class="row">
                	<div class="col-md-offset-4  col-md-4 ">
                		...
                		<form action="" method="post">
                			<input type="submit" name="submit" value="Process Product" class="btn btn-info btn-fill">
                		</form>
                	</div>
                </div>
                <?php } ?>
